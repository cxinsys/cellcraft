...
readonly COMPOSE_FILE="${SCRIPT_DIR}/docker-compose.gpu.yml"
...
show_final_status() {
    ...
    echo -e "  • View logs: ${CYAN}docker compose -f docker-compose.gpu.yml logs${NC}"
    echo -e "  • Stop services: ${CYAN}docker compose -f docker-compose.gpu.yml down${NC}"
    echo -e "  • Restart services: ${CYAN}docker compose -f docker-compose.gpu.yml restart${NC}"
    echo ""
