  ...
  <section>
    <div class="files__header">
      <div class="l-col">
        ...
        <img class="files__header__img" src="@/assets/descending-filter-desc.png" alt="">
      </div>
      <div class="l-col">
    ...
    <ul class="files__contents" @click="ClickOut">
      <li class="files__contents__item" v-for="(file, idx) in files_list" :key="idx" @contextmenu.prevent @click.right="RMouseClick($event)" v-bind:class="{select:R_Mouse_isActive}">
        <div class="l-col">{{file.file_name}}</div>
        <div class="l-col">{{file.file_size}}</div>
        <div class="l-col">{{file.created_at}}</div>
      </li>
      <ul ref="filesMenu" class="files_menu" v-bind:class="{open: R_Mouse_isActive}" :style="{left:xPosition, top:yPosition}">
        <li>view</li>
        <li>plot</li>
        <li>rename</li>
        <li>delete</li>
